...
public class FXMLDocumentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        System.out.println("BBDD instanciada");
        // 1. Autenticación
        boolean ok = app.login("testuser", "Password1!");
        if (ok) {
            System.out.println("Sesión iniciada con el usuario: " + app.getCurrentUser().getNickName());
         ...
         *
         * Nota: accedemos al Stage del diálogo para poder personalizar su
         * icono, ya que Alert no expone directamente esa propiedad.
         *
        ...
        /**
         * Muestra un diálogo para introducir el nombre del nuevo POI, lo añade
         * al ListView y dibuja su etiqueta sobre el mapa.
         *
         * @param x coordenada X del clic en el sistema local del mapPane
         * @param y coordenada Y del clic en el sistema local del mapPane
         */
